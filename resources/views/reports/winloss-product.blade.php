...
{  
    locale['prd_id'] = "{!! __('app.reports.winloss.maindata.prdid') !!}" ;
    locale['prd_name'] = "{!! __('app.reports.winloss.maindata.prdname') !!}" ;
...
/*    if($("#s_date").val() == '')
    ...
    $.ajax({
        type: "GET",
        url: "/ajax/reports/winloss/products",
        data: data,
...
{ 
    ...
    var fields = [  
                ["prd_id", locale['prd_id'],true,false]
    ...
    if(table != null)
    {
        ...
        { 
            ...
            var memberId = mainData.results[i-1]["member_id"];
            ...
            a.href = "/reports/winloss/details?product=" + prdId + "&member_id=" + memberId+ "&username=" + username+"&s_date="+$("#s_date1").val()+"&e_date="+$("#e_date1").val();    
...
<ol class="breadcrumb">
    ...
    <li id="breadcrumb-own" class="breadcrumb-item" href="reports/winloss">{{ Auth::user()->username }}</li>
