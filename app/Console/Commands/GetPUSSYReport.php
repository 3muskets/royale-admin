...
class GetPUSSYReport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'GetPUSSYReport';
     ...
     * @var string
     */
    protected $description = 'Get PUSSY Report';
    ...
    {
        Log::info('Cron : GetPUSSYReport START');
        ...
        catch (\Exception $e)
        {
            ...
            Log::info('Cron : GetPUSSYReport ERROR - '.$e);
        }

        // check allow cron to proceed
        if (!$allowCron)
        {          
            Log::info('Cron : GetPUSSYReport TERMINATED');
            return;
        }
        ...
        Log::info('Cron : GetPUSSYReport END');
    }
}